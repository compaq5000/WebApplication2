<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileUploadarchivo.aspx.cs" Inherits="WebApplication2.FileUploadarchivo" %>
      ...
      <telerik:RadScriptManager ID="RadScriptManager1" runat="server"></telerik:RadScriptManager>
        ...
        <fieldset>
            <legend style="background-image: url('img/naranja.png'); text-align: left;font-size:larger;font-family:'Century Gothic'; margin-top: 0; height: 30px; box-shadow: 0 8px 6px -6px black;"><strong>
                <asp:Label ID="Label1" runat="server" Text="DOCUMENTACIÓN EXISTENTE DENTRO DEL EXPEDIENTE TECNICO"></asp:Label>
            </strong></legend>
