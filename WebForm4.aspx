    ...
    <form id="form1" runat="server">
        <div>
            <telerik:ReportViewer ID="ReportViewer2" runat="server" ScaleMode="FitPageWidth">
                <ReportSource Identifier="ReportLibrary.Report3, ReportLibrary, Version=15.2.21.915, Culture=neutral, PublicKeyToken=null" IdentifierType="TypeReportSource"></ReportSource>
