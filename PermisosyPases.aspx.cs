...
{
    public partial class PermisosyPases : System.Web.UI.Page
    {
        ...
        protected void RadGrid1_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
        {
            SubSonicDB.ViewRHJustificanteCollection ssJustificantes = new SubSonicDB.ViewRHJustificanteCollection()
                .Where(SubSonicDB.ViewRHJustificante.Columns.Expr1, ssSesiones.IDUsua)
        ...
        protected void RadButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ssNew.IDUser = Convert.ToInt32(ssSesiones.IDUsua);
