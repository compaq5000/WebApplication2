...
{
    /// <summary>
    /// Strongly-typed collection for the ArboladoGridCorrespondencium class.
    /// </summary>
    [Serializable]
    public partial class ArboladoGridCorrespondenciumCollection : ReadOnlyList<ArboladoGridCorrespondencium, ArboladoGridCorrespondenciumCollection>
    {
        public ArboladoGridCorrespondenciumCollection() { }
    }
    /// <summary>
    /// This is  Read-only wrapper class for the ArboladoGridCorrespondencia view.
    /// </summary>
    [Serializable]
    public partial class ArboladoGridCorrespondencium : ReadOnlyRecord<ArboladoGridCorrespondencium>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("ArboladoGridCorrespondencia", TableType.View, DataService.GetInstance("Default"));
                ...
                colvarBuscaCorres.MaxLength = 3501;
                ...
                DataService.Providers["Default"].AddSchema("ArboladoGridCorrespondencia", schema);
            }
        }
        #endregion
        ...
        #region .ctors
        public ArboladoGridCorrespondencium()
        {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ArboladoGridCorrespondencium(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public ArboladoGridCorrespondencium(object keyID)
        {
            SetSQLProps();
            LoadByKey(keyID);
        }

        public ArboladoGridCorrespondencium(string columnName, object columnValue)
        {
            SetSQLProps();
